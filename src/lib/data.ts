...
export const mission = {
  ...
  description: 'La mission principale de BTLABS est d\'accompagner les industries, collectivités et projets de développement dans la maîtrise de leurs impacts environnementaux et sanitaires, en fournissant des mesures fiables, des analyses scientifiques rigoureuses et des solutions adaptées pour améliorer durablement leur performance et leur conformité réglementaire.',
